...
<div class="form-group {{ $errors->has('queue') ? 'has-error' : ''}}">
    {!! Form::label('queue', 'Queue', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('queue', null, ['class' => ($errors->has('queue')) ? 'form-control is-invalid' : 'form-control']) !!}

        {!! $errors->first('queue', '<div class="invalid-feedback d-block">:message</div>') !!}
    </div>
</div>
