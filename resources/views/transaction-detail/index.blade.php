    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Transactiondetails Lists</h3>
                <div class="nk-block-des text-soft">
		    <p>List all Transactiondetails</p>
                </div>
            </div>
            <div class="nk-block-head-content">
                <div class="toggle-wrap nk-block-tools-toggle">
                    ...
                    <div class="toggle-expand-content" data-content="pageMenu">
                        <ul class="nk-block-tools g-3">
                            <li>
                                <a href="{{ url('/transaction-detail/create') }}" class="btn btn-primary">
                                    <em class="icon ni ni-plus"></em>
                                    <span>Create New Transactiondetail</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card-search search-wrap" data-search="search">
                        <div class="card-body">
                            <div class="search-content">
                                ...
                                {!! Form::open(['method' => 'GET', 'url' => '/transaction-detail'])  !!}
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <thead class="thead-light">
                                <tr>
                                    <th>#</th><th>Transaction Id</th><th>Category Id</th><th>Description</th><th>Actions</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse($transactiondetail as $item)
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td>{{ $item->transaction_id }}</td><td>{{ $item->category_id }}</td><td>{{ $item->description }}</td>
                                        <td>
